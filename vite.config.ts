...
let optimizerOptions: OptimizeOptions = {
    logs: process.env.LOG_LEVEL && Object.keys(LogLevel).includes(process.env.LOG_LEVEL) ? LogLevel[process.env.LOG_LEVEL as keyof typeof LogLevel] : LogLevel.NORMAL,
};
