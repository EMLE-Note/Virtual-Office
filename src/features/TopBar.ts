...
export function mountTopBar() {
  ...
  function badge(label: string, value = "—") {
  ...
  async function loadKPIs() {
    try {
      ...
      bOver.style.background = (payload.overdue_tasks ?? 0) > 0 ? "rgba(255, 77, 79, 0.25)" : "rgba(255,255,255,0.12)";
      ...
      bHours.textContent = "Hours Today: —";
      bAtt.textContent = "Attendance: —";
